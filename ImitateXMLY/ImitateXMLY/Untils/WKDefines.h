...
#define WKGetStringWithKeyFromTable(key, tbl)\
[[WKLanguageTool sharedInstance] getStringForKey:key withTable:tbl]
...
#define CNS @"zh-Hans" //!< 简体中文
#define CNF @"zh-Hant" //!< 繁体中文
#define EN @"en" //!< 英语
#define KOR @"ko" //!< 韩语
#define JP @"ja" //!< 日语
#define FR @"fr" //!< 法语
